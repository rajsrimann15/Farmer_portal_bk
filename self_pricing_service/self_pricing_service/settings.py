"""
Django settings for self_pricing_service project.
...
SECRET_KEY = 'django-insecure-e*(o-psuw#fe5$zc!6i$8$4(9&r(kp2kxp%2hbg@(l#j-4!!g0'
...
ROOT_URLCONF = 'self_pricing_service.urls'
...
WSGI_APPLICATION = 'self_pricing_service.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'farmer_portal_self_pricing_service',
        'USER': config('DB_USER'),
